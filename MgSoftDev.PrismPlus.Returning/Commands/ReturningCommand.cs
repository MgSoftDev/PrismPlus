...
public class ReturningCommand : DelegateCommandBase
{
    Func<ReturningCore.Returning>   _ExecuteMethod;
    ...
    /// <summary>
    /// Creates a new instance of <see cref="ReturningCommand"/> with the <see cref="Action"/> to invoke on execution.
    /// </summary>
    /// <param name="executeMethod">The <see cref="Action"/> to invoke when <see cref="ICommand.Execute(object)"/> is called.</param>
    public ReturningCommand(Func<ReturningCore.Returning> executeMethod) : this(executeMethod, ()=>true) { }
    ...
    public ReturningCommand(Func<ReturningCore.Returning> executeMethod, Func<bool> canExecuteMethod) : base()
    {
    ...
    /// <returns></returns>
    public ReturningCommand StartAction(Action startAction)
    {
    ...
    /// <returns></returns>
    public ReturningCommand EndAction(Action<ReturningCore.Returning> endAction)
    {
    ...
    /// <returns></returns>
    public ReturningCommand StartAction(Func<bool> canExecuteAction)
    {
    ...
    /// <returns></returns>
    public ReturningCommand SaveLog(string errorName = "Unhandled error", ReturningEnums.LogLevel logLevel = ReturningEnums.LogLevel.Error, string errorCode = "ErrorInfo.UnhandledError")
    {
        _SaveLog   = true;
    ...
    public void Execute()
    {
        ...
        var res = ReturningCore.Returning.Try(()=>_ExecuteMethod(), _ErrorName, _ErrorCode);
        if (_SaveLog) res.SaveLog(_LogLevel);
    ...
    public ReturningCommand ObservesProperty< T >(Expression<Func<T>> propertyExpression)
    {
    ...
    /// <returns>The current instance of AsyncDelegateCommand</returns>
    public ReturningCommand ObservesCanExecute(Expression<Func<bool>> canExecuteExpression)
    {
...
/// </example>
/// </remarks>
public class ReturningCommand< T > : DelegateCommandBase
{
    readonly Func<T, ReturningCore.Returning> _ExecuteMethod;
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ReturningCommand"/>.
    /// </summary>
    /// <param name="executeMethod">Delegate to execute when Execute is called on the command. This can be null to just hook up a CanExecute delegate.</param>
    /// <remarks><see cref="CanExecute(T)"/> will always return true.</remarks>
    public ReturningCommand(Func<T, ReturningCore.Returning> executeMethod) : this(executeMethod, (o)=>true) { }
    ...
    public ReturningCommand(Func<T, ReturningCore.Returning> executeMethod, Func<T, bool> canExecuteMethod) : base()
    {
        if (executeMethod == null || canExecuteMethod == null) throw new ArgumentNullException(nameof(executeMethod), "AsyncDelegateCommand Delegates Cannot Be Null");
    ...
    /// <param name="startAction"></param>
    /// <returns></returns>
    public ReturningCommand<T> StartAction(Action<T> startAction)
    {
        _StartAction = startAction;
    ...
    /// <param name="endAction"></param>
    /// <returns></returns>
    public ReturningCommand<T> EndAction(Action<T, ReturningCore.Returning> endAction)
    {
        _EndAction = endAction;
    ...
    /// <param name="startActionAsync"></param>
    /// <returns></returns>
    public ReturningCommand<T> StartAction(Func<T, bool> canExecuteAction)
    {
        _CanExecuteMethod = canExecuteAction ?? throw new ArgumentNullException(nameof(canExecuteAction), "AsyncDelegateCommand Delegates Cannot Be Null");
    ...
    /// <param name="errorCode"></param>
    /// <returns></returns>
    public ReturningCommand<T> SaveLog(string errorName = "Unhandled error", ReturningEnums.LogLevel logLevel = ReturningEnums.LogLevel.Error, string errorCode = "ErrorInfo.UnhandledError")
    {
        _SaveLog   = true;
        _ErrorName = errorName;
        _ErrorCode = errorCode;
    ...
    public void Execute(T parameter)
    {
        ...
        IsActive = true;
        RaiseCanExecuteChanged();
        var res = ReturningCore.Returning.Try(()=>_ExecuteMethod(parameter), _ErrorName, _ErrorCode);
        if (_SaveLog) res.SaveLog(_LogLevel);
    ...
    /// <param name="propertyExpression">The property expression. Example: ObservesProperty(() => PropertyName).</param>
    /// <returns>The current instance of AsyncDelegateCommand</returns>
    public ReturningCommand<T> ObservesProperty< TType >(Expression<Func<TType>> propertyExpression)
    {
        ObservesPropertyInternal(propertyExpression);
    ...
    /// <param name="canExecuteExpression">The property expression. Example: ObservesCanExecute(() => PropertyName).</param>
    /// <returns>The current instance of AsyncDelegateCommand</returns>
    public ReturningCommand<T> ObservesCanExecute(Expression<Func<bool>> canExecuteExpression)
    {
